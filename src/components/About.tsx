...
const About = () => {
  const skills = [
    ...
    { name: "JavaScript", level: "Advanced", color: "bg-primary" },
    { name: "Next.js", level: "Intermediate", color: "bg-accent" },
    { name: "React", level: "Advanced", color: "bg-success" },
    { name: "Node.js", level: "Intermediate", color: "bg-primary" },
    ...
    { name: "MongoDB", level: "Intermediate", color: "bg-accent" },
    { name: "Tailwind CSS", level: "Advanced", color: "bg-success" },
  ];
