  ...
  const contactInfo = [
    {
      icon: Mail,
      label: "Email",
      value: "keerthanmgowda03@gmail.com",
      action: () => window.open('mailto:keerthanmgowda03@gmail.com'),
    ...
    },
    {
      icon: Github,
      label: "GitHub",
      value: "github.com/Keerthan17",
      action: () => window.open('https://github.com/Keerthan17', '_blank'),
            ...
            <Card className="p-8 gradient-card border-border/50">
              ...
              <div className="grid grid-cols-1 sm:grid-cols-2 gap-4 mb-8">
                <Button 
                  ...
                  size="lg" 
                  className="w-full"
                  onClick={() => window.open('mailto:keerthanmgowda03@gmail.com?subject=Hello%20Keerthan&body=Hi%20Keerthan,%0A%0AI%20found%20your%20portfolio%20and%20would%20like%20to%20discuss...', '_blank')}
                >
                ...
                <Button 
                  ...
                  size="lg" 
                  className="w-full"
                  onClick={() => window.open('https://github.com/Keerthan17', '_blank')}
                >
              ...
              <div className="text-center">
                ...
                <Button 
                  variant="outline" 
                  onClick={() => window.open('mailto:keerthanmgowda03@gmail.com', '_blank')}
                >
          ...
          <div className="relative z-10">
            ...
            <div className="flex flex-col sm:flex-row gap-4 justify-center">
              <Button 
                variant="hero" 
                size="lg"
                onClick={() => window.open('mailto:keerthanmgowda03@gmail.com?subject=Project%20Collaboration&body=Hi%20Keerthan,%0A%0AI%20have%20an%20exciting%20project%20idea...', '_blank')}
              >
                <Send className="mr-2 h-5 w-5" />
                Start a Project
              </Button>
